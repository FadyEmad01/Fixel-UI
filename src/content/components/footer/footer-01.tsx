    ...
    return (
        <>
            <footer className="relative bg-black overflow-hidden w-full">
                        ...
                        <div className="grid grid-cols-6 gap-6">
                            <div className="col-span-6 flex flex-col gap-4 pt-5 md:col-span-4">
                                <a className="w-max" href="#">
                                    <Image alt="Fixel UI" src={'/logo-png.svg'}
                                        width={0}
                                        height={0}
                ...
                <div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 md:w-[800px] md:h-[400px] w-[200px] h-[400px] bg-blue-900/40 opacity-50 blur-[120px] rounded-full pointer-events-none z-0" />
            </footer>
        </>
    );
};